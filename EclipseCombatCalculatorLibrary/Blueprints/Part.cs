...
namespace EclipseCombatCalculator.Library.Blueprints
{
    public sealed class Part
    {
        ...
        // Weapons
        public static readonly Part IonCannon = new Part("Ion Cannon") { Cannons = new[] { CommonDices.YellowDice }, Energy = -1 };
        ...
        // Computers
        public static readonly Part ElectronComputer = new Part("Electron Computer") { Computers = 1 };
        ...
        // Hulls
        public static readonly Part Hull = new Part("Hull") { Hulls = 1 };
        ...
        // Drives
        public static readonly Part NuclearDrive = new Part("Nuclear Drive") { Movement = 1, Initiative = 1, Energy = -1 };
        ...
        // Energy sources
        public static readonly Part NuclearSource = new Part("Nuclear Source") { Energy = 3 };
        ...
        // Ancient ship parts
        public static readonly Part IonDisruptor = new Part("Ion Disruptor") { Cannons = new[] { CommonDices.YellowDice }, Initiative = 4 };
        public static readonly Part IonTurret = new Part("Ion Turret") { Cannons = new[] { CommonDices.YellowDice, CommonDices.YellowDice } };
        public static readonly Part PlasmaTurret = new Part("Plasma Turret") { Cannons = new[] { CommonDices.OrangeDice, CommonDices.OrangeDice }, Energy = -3 };
        public static readonly Part SolitonCharger = new Part("Soliton Charger") { Cannons = new[] { CommonDices.BlueDice }, Energy = -1 };
        public static readonly Part RiftConductor = new Part("Rift Conductor") { Cannons = new[] { CommonDices.PurpleDice }, Hulls = 1, Energy = -1 };
        public static readonly Part IonMissile = new Part("Ion Missile") { Missiles = new[] { CommonDices.YellowDice, CommonDices.YellowDice, CommonDices.YellowDice } };
        public static readonly Part SolitonMissile = new Part("Soliton Missile") { Missiles = new[] { CommonDices.BlueDice }, Initiative = 1 };
        public static readonly Part AntimatterMissile = new Part("Antimatter Missile") { Missiles = new[] { CommonDices.RedDice } };
        public static readonly Part AxionComputer = new Part("Axion Computer") { Computers = 2, Initiative = 1 };
        public static readonly Part FluxShield = new Part("Flux Shield") { Shields = 3, Initiative = 1, Energy = -2 };
        public static readonly Part InversionShield = new Part("Inversion Shield") { Shields = 2, Energy = 2 };
        public static readonly Part ShardHull = new Part("Shard Hull") { Hulls = 3 };
        public static readonly Part ConformalDrive = new Part("Conformal Drive") { Movement = 4, Initiative = 2, Energy = -2 };
        public static readonly Part NonLinearDrive = new Part("Nonlinear Drive") { Movement = 2, Energy = 2 };
        public static readonly Part HypergridSource = new Part("Hypergrid Source") { Energy = 11 };

        // Esoteric parts
        public static readonly Part JumpDrive = new Part("Jump Drive") { Energy = -2 };
        public static readonly Part MorphShield = new Part("Morph Shield") { Initiative = 1, Shields = 1 }; // TODO
        public static readonly Part MuonSource = new Part("Muon Source") { Initiative = 1, Energy = 2 };
    }
}
